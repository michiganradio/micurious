Curiouscity::Application.routes.draw do
  ...
  match '/questions/:status/categories(/:category_name)', to: 'questions#filter', via: 'get', as: 'filter_questions', constraints: { status: /new_unanswered|answered_investigating/}
