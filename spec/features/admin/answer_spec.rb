  ...
  describe "add answer" do
    ...
    context "type selected" do
      it "adds answer" do
        ...
        @admin_answers_page.answer_urls[0].text.should eq "url"
        @admin_answers_page.answer_labels[0].text.should eq "label"
        @admin_answers_page.answer_types[0].text.should eq Answer::Type::Answer
      end
      ...
      it "adds update" do
        ...
        @admin_answers_page.answer_urls[0].text.should eq "url"
        @admin_answers_page.answer_labels[0].text.should eq "label"
        @admin_answers_page.answer_types[0].text.should eq Answer::Type::Update
      end
    end
  end
end
